...
class GuestRepository {
    ...
    public function katalog_home($request) {
    ...
    public function related_product($product_detail, $id, $code) {
        ...
        $related_product = $this->katalog_related_product($product_name, $category, $id, $code);
        return $related_product;
    }

    public function katalog_related_product($product_name, $category, $id, $code) {
        $related_product = ProductVendor::select('product_vendors.*')
            ...
            ->where('product_vendors.id', '!=', $id)
            ->where('status', 1);
        $related_product = $related_product->addSelect(DB::raw("'".$code."' as code"));
        return $related_product;
    }
