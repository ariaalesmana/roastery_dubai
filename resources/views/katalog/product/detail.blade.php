                            ...
                            <div class="owl-carousel nav-style2" data-autoplay="false" data-nav="false" data-dots="false" data-loop="false" data-slidespeed="800" data-margin="30"  data-responsive = '{"0":{"items":1},"480":{"items":1}, "768":{"items":1}, "1024":{"items":1}, "1200":{"items":1}}'>
                                ...
                                <ul class="list-recent-posts">
                                    ...
                                    <li class="product-item">
                                        <div class="thumb">
                                            <a @if(Auth::guest()) href="{{ route('guest.detail.product', [$d->code, Illuminate\Support\Facades\Crypt::encryptString($d->id)]) }}" @else href="{{ route('katalog.detail.product', $d->id) }}" @endif>
                                        ...
                                        <div class="info">
                                            <a @if(Auth::guest()) href="{{ route('guest.detail.product', [$d->code, Illuminate\Support\Facades\Crypt::encryptString($d->id)]) }}" @else href="{{ route('katalog.detail.product', $d->id) }}" @endif class="product-name">{{ $d->product->name }}</a>
                                            <div class="price">
