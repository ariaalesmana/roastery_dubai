...
<div class="container-fluid" style="margin-top:16px;">
    <div class="animated fadeIn">
        <form id="forms" method="post" action="{{ route('vendor.product.edit_post', [Auth::user()->group->code]) }}" enctype="multipart/form-data" role="form">
            <div class="card">
                {{ csrf_field() }}
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <textarea rows="3" class="form-control" id="name" name="name" type="text">{{ $product->product->name }}</textarea>
                        </div>
                        <label class="col-md-2 col-form-label text-right" for="name">QRCode</label>
                        @if($product->product->qrcode)
                            <div class="col-md-4">
                                <a href="{{route('vendor.product.hapusqr', [Auth::user()->group->code, Crypt::encryptString($product->product->id)])}}" class="btn btn-sm btn-danger">Hapus</a>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" id="price" name="price" type="text" data-type="currency" value="{{ number_format($product->price, 0) }}">
                        </div>
                        <label class="col-md-2 col-form-label text-right" for="unit">Satuan <i class="text-danger">*</i></label>
                        <div class="col-md-4">
                            <input class="form-control" id="unit" name="unit" type="text" value="{{ $product->product->unit }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="sku">SKU <i class="text-danger">*</i></label>
                        <div class="col-md-4">
                            <input class="form-control" id="sku" name="sku" type="text" value="{{ $product->product->sku }}">
                        </div>
                        <label class="col-md-2 col-form-label text-right" for="vendor_sku">Vendor SKU <i class="text-danger">*</i></label>
                        <div class="col-md-4">
                            <input class="form-control" id="vendor_sku" name="vendor_sku" type="text" value="{{ $product->product->vendor_sku }}">
                        </div>
                    </div>
                    <?php 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" id="stock" name="stock" type="text" data-type="currency" value="{{ $product->stock }}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="description">Deskripsi <i class="text-danger">*</i></label>
                        <div class="col-md-10">
                            <textarea id="description" class="form-control" name="description">{{ $product->product->description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="short_description">Deskripsi Singkat <i class="text-danger">*</i></label>
                        <div class="col-md-10">
                            <textarea id="short_description" class="form-control" name="short_description">{{ $product->product->short_description }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
