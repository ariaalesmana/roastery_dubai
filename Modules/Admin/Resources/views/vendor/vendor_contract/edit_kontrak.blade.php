...
@section('content')
<ol class="breadcrumb">
    <li class="breadcrumb-item">Edit Kontrak</li>
</ol>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <select class="custom-select val-custom form-control select2 @if($errors->has('vendor_name')) is-invalid @endif" data-placeholder="Pilih Vendor" name="vendor_name" id="vendor_name">
                                ...
                                <option value="{{ $vm->id }}" @if($vm->id == $vendor_contract_master->vendor_master_id) selected @endif>{{ $vm->vendor_name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            <select class="custom-select val-custom form-control select2 @if($errors->has('category')) is-invalid @endif" data-placeholder="Pilih Kategori" name="category" id="category">
                                ...
                                <option value="{{ $c->id }}" @if($c->id == $vendor_contract_master->category) selected @endif>{{ $c->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control @if($errors->has('contract_name')) is-invalid @endif" id="contract_name" name="contract_name" type="text" @if (old('contract_name') != null) value="{{ old('contract_name') }}" @else value="{{ $vendor_contract_master->contract_name }}" @endif>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control @if($errors->has('contract_no')) is-invalid @endif" id="contract_no" name="contract_no" type="text" @if (old('contract_no') != null) value="{{ old('contract_no') }}" @else value="{{ $vendor_contract_master->contract_no }}" @endif>
                        ...
                        <div class="col-md-4">
                            <input class="form-control @if($errors->has('contract_price')) is-invalid @endif" id="contract_price" name="contract_price" data-type="currency" type="text" @if (old('contract_price') != null) value="{{ old('contract_price') }}" @else value="{{ number_format($vendor_contract_master->contract_price, 0) }}" @endif>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-4">
                            <input class="form-control js-datepicker @if($errors->has('contract_start')) is-invalid @endif" id="contract_start" autocomplete="off" name="contract_start" type="text" @if (old('contract_start') != null) value="{{ old('contract_start') }}" @else value="{{ date('d-M-Y', strtotime($vendor_contract_master->contract_start)) }}" @endif>
                        ...
                        <div class="col-md-4">
                            <input class="form-control js-datepicker @if($errors->has('contract_end')) is-invalid @endif" id="contract_end" autocomplete="off" name="contract_end" type="text" @if (old('contract_end') != null) value="{{ old('contract_end') }}" @else value="{{ date('d-M-Y', strtotime($vendor_contract_master->contract_end)) }}" @endif>
