...
@section('content')
<ol class="breadcrumb">
    <li class="breadcrumb-item">Edit Sub Kategori</li>
</ol>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" id="subcategory" name="subcategory" type="text" value="{{ $subcategory->name }}">
                    </div>
                </div>
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            <label class="col-form-label switch switch-md switch-label switch-pill switch-primary">
                                <input class="switch-input" type="checkbox" id="status_subcategory" name="status_subcategory" onclick="checkBox()" @if($subcategory->status == 1) value="1" checked @else value="0" @endif>
