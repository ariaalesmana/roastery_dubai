            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10" id="cat">
                        <select class="form-control select2" data-placeholder="Kategori" name="category" id="category" onchange="functionCategory()">
                            <option></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10" id="subcat">
                        <select class="form-control select2" data-placeholder="Sub Kategori" name="subcategory" id="subcategory">
                            <option></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input class="form-control" id="subsubcategory" name="subsubcategory" type="text" value="{{ $subsubcategory->name }}">
                    </div>
                </div>
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            <label class="col-form-label switch switch-md switch-label switch-pill switch-primary">
                                <input class="switch-input" type="checkbox" id="status_subsubcategory" name="status_subsubcategory" onclick="checkBox()" @if($subsubcategory->status == 1) value="1" checked @else value="0" @endif>
    ...
    function functionCategory() {
        ...
        $.ajax({
            ...
            success: function(response) {
                var html = `<select class="form-control select2" data-placeholder="Sub Kategori" id="subcategory" name="subcategory">
                                <option></option>`;
