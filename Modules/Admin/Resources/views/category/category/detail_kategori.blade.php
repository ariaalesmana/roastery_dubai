        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-md-2 col-form-label" for="category">Kategori</label>
                    <div class="col-md-10">
                        <input class="form-control" id="category" name="category" type="text" value="{{ $category->name }}" readonly>
                    </div>
                </div>
                    ...
                    <div class="col-md-10">
                        <div class="input-group">
                            <label class="col-form-label switch switch-md switch-label switch-pill switch-primary">
                                <input class="switch-input" type="checkbox" id="status_category" name="status_category" onclick="checkBox()" @if($category->status == 1) value="1" checked @else value="0" @endif disabled>
