                ...
                <div class="form-group row">
                        ...
                        <div class="input-group">
                            <span class="input-group-btn">
                                <span class="btn btn-default btn-file" style="border:1px solid #00555555;">
                                    Browse… <input type="file" id="imgInp" name="image" disabled>
                                </span>
                            </span>
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <span class="input-group-btn">
                                <span class="btn btn-default btn-file" style="border:1px solid #00555555;">
                                    Browse… <input type="file" id="imgInp2" name="small_image" disabled>
                                </span>
                            </span>
                            <input type="text" class="form-control" readonly>
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="input-group">
                            <span class="input-group-btn">
                                <span class="btn btn-default btn-file" style="border:1px solid #00555555;">
                                    Browse… <input type="file" id="imgInp3" name="thumbnail" disabled>
                                </span>
                            </span>
                            <input type="text" class="form-control" readonly>
                        </div>
                            ...
                            <tbody style="border: none;">
                                ...
                                <tr style="border: none;">
                                    ...
                                    <td width="5%" class="text-right" style="border: none;">
                                        <button type="button" class="btn btn-danger hapus"><i class="fa fa-trash" disabled></i></button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
